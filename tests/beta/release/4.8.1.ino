/*
 * PocketDoctor v4.8.1 – AI-Powered Diagnostic & Autonomous SOS Assistant
 ...
 * - Emergency SOS Mode: Joystick severity selection (1–10) & Direct SSL SMTP Engine (WiFiClientSecure)
 */
...
void dispatchSOSAlert() {
  ...
  client.println("==========================================");
  client.println("  EMERGENCY SOS ALERT ACTIVATED");
  client.println("==========================================");
  client.println("Severity Level   : " + String(sosLevel) + " / 10");
  client.println("Patient Name     : " + (currentProfile.name.length() > 0 ? currentProfile.name : "Not Specified"));
  client.println("Patient Age      : " + String(currentProfile.age) + " yrs");
  client.println("Patient Height   : " + String(currentProfile.height) + " cm");
  client.println("Patient Weight   : " + String(currentProfile.weight) + " kg");
  client.println("Intoxication     : " + currentProfile.intoxStatus);
  client.println("Medical History  : " + String(currentProfile.hasMedicalHistory ? "Yes" : "No"));
  client.println("Treatment Pref   : " + currentProfile.treatmentPreference);
  client.println("------------------------------------------");
  client.println("Device IP        : " + WiFi.localIP().toString());
  client.println("Wi-Fi SSID       : " + WiFi.SSID());
  client.println("System Uptime    : " + String(millis() / 1000) + " seconds");
  client.println("==========================================");
  client.println("This is an automated emergency message dispatched from PocketDoctor Mark 4.");
  client.println();
  ...
  display.setCursor(0, 20);
  if (sentSuccess) {
    display.println("SOS Email Sent!");
